\documentclass[letter,11pt,twoside,printwatermark=false]{pinp}
...
\NormalTok{mpr <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{name  =} \StringTok{"sphere"}\NormalTok{, }\DataTypeTok{xmin  =} \NormalTok{-}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{20}\NormalTok{), }\DataTypeTok{xmax  =} \DecValTok{20} \NormalTok{+}\StringTok{ }\DecValTok{5} \NormalTok{*}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DecValTok{24}\NormalTok{))}
\NormalTok{my.seed <-}\StringTok{ }\DecValTok{1998}  \CommentTok{# <--- ATTENTION: USE THE BIRTH YEAR OF YOUNGEST TEAM MEMBER}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{ExpDE}\NormalTok{(mpo, mmu, mre, mse, mst, mpr, }\DataTypeTok{seed =} \NormalTok{my.seed,}
      \DataTypeTok{showpars =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{show.iters =} \StringTok{"none"}\NormalTok{))$Fbest}
\end{Highlighting}
\end{Shaded}
